...
namespace PaymentContext.Domain.Handlers
{
    ...
    IHandler<CreatePayPalSubscriptionCommand>
    {
        ...
        public ICommandResult Handle(CreateBoletoSubscriptionCommand command)
        {
            ...
            if(Invalid)
                return new CommandResult(false, "Erro ao tentar assinar");

            //Salvar as Informações
            _repository.CreateSebscription(student);

            //Enviar E-mail de boas vindas
            _emailService.Send(student.Name.FirstName, student.Email.Address, "Assinatura", "Parabéns Brother");

            //Retornar informações
            return new CommandResult(true, "Assinatira realizada com sucesso");
        }
